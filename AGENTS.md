...
- **Stack Técnico Detectado:** Python (FastAPI/Flask - ASGI uvicorn), SQLite (tpv_data.sqlite), HTML/JS/CSS vainilla (PWA), Render, GitHub.

- **Estructura Principal:** backend/, static/, scripts/, tests/.
...
- **Reglas de Render:** Despliegue automático (rama main). Comprobar render.yaml.

- **Archivos/Datos Delicados:** tpv_data.sqlite, render.yaml, backend/main.py.
