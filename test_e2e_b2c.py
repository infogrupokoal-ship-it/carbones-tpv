...
def run_e2e():
    ...
    auth_res = requests.post(f"{BASE_URL}/api/b2c/auth", json={"telefono": "34600000001", "nombre": "Pepe Test"})
    ...
    ped_res = requests.post(f"{BASE_URL}/api/pedidos?cliente_id={cliente_id}", json=pedido_payload)
    ...
    estado_res = requests.post(f"{BASE_URL}/api/pedidos/{pedido_id}/estado?estado=LISTO")
