...
def seed():
    ...
    try:
        ...
        db.query(Producto).filter(Producto.precio == 4.50).delete(synchronize_session=False) # delete dummy
        ...
        products = [
            ...
            ("Chivito de Pollo", 6.50, "Bocadillos y Chivitos", "Mayonesa, tomate, cebolla, lechuga, pechuga de pollo, queso y bacon"),
            ...
            # Brascadas
            ("Brascada", 6.50, "Brascadas", "Mayonesa, tomate, cebolla plancha, ternera y jamon serrano"),
            ("Brascada de Lomo", 5.50, "Brascadas", ""),
            ("Brascada de Caballo", 7.00, "Brascadas", ""),
            
            # Especiales de la Casa
            ("Bocadillo Caramelizado La Granja", 7.50, "Especiales de la Casa", "Cebolla caramelizada, queso de cabra, pechuga de pollo, queso, bacon y jamon serrano"),
            ("Sobrasada, Lomo, queso y bacon", 5.00, "Especiales de la Casa", ""),
            ("Lomo, pimientos, cebolla a la plancha", 5.00, "Especiales de la Casa", ""),
            ...
            # Bocadillos Clásicos
            ("Bocadillo Vegetal", 5.50, "Bocadillos Clásicos", "Mayonesa, tomate, cebolla, lechuga, atun, huevo duro, maiz y esparragos"),
            ...
            ("Pechuga Empanada", 5.50, "Bocadillos Clásicos", "Pechuga, mayonesa, queso, bacon y patatas"),
            ("Huevos fritos, chistorra, patatas y alioli", 5.50, "Bocadillos Clásicos", ""),
        ...
        for name, price, c_name, desc in products:
            ...
            if not p:
                p = Producto(nombre=name, precio=price, categoria_id=cat_map[c_name], descripcion=desc, stock_actual=50) # Stock inicial alto
                db.add(p)
        ...
        if cat_old:
            db.query(Producto).filter(Producto.categoria_id == cat_old.id).delete(synchronize_session=False)
            db.delete(cat_old)
