...
try:
    ...
    print(f"[*] Ejecutando Comando Curl a Port 3000...")
    ...
    if "Unauthorized" in res_3000 or "Session not found" in res_3000 or "401" in res_3000:
        print(f"[*] Port 3000 falló. Intentando Port 3002...")
